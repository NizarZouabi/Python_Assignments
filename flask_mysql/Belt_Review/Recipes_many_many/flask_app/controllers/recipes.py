...
def view(id):
    ...
    liked_recipe = recipe.Recipe.get_recipe_with_likes(data)
    this_recipe = recipe.Recipe.get_recipe_with_owner(data)
    return render_template('view.html', recipe = this_recipe, recipe_likes = liked_recipe)
...
def remove_like(id):
    ...
    recipe.Recipe.remove_like(data)
    return redirect('/dashboard')
